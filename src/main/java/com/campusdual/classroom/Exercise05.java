...
public class Exercise05 {
    public static void main(String[] args) {
        ...
        Exercise05.checkLessOrGreaterEqual(5,3);
        Exercise05.checkLessOrGreaterEqual(5,5);
        Exercise05.checkLessOrGreaterEqual(3,5);
        Exercise05.checkMultiply(9, 4);
        Exercise05.checkMultiply(8, 4);
